            ...
            <div>
                <main className="w-full">
                    <section className="flex flex-col items-center gap-[2em] w-full p-[2em]">
                        ...
                        {chats.length > 0 ? (
                            <aside className="flex flex-col w-9/10 items-start">
                                {chats.map((chat) => (
                                    <div key={chat.id} className="flex flex-col w-full p-[1em] border border-gray-400 rounded-xl shadow-md">
            ...
            <div>
                <main className="w-full">
                    <section className="flex flex-col items-center gap-[2em] w-full p-[2em]">
                        ...
                        <LogoutButton />
                        {chats.length > 0 ? (
                            <aside className="flex flex-col w-full items-start">
                                {chats.map((chat) => (
                                    <div key={chat.id}>
                                        <h2>{chat.name}</h2>
